...
bool checkForUpdates(string& latestVersion, string& downloadUrl) {
    ...
    if (downloadUrl.empty()) {
        ...
        cout << "Debug: Using constructed URL: " << downloadUrl << endl;
...
bool downloadUpdate(const string& url) {
    ...
    if (url.empty() || url == ":" || url.length() < 10) {
        ...
        urlsToTry = {
            "https://github.com/lackyhy/7SCW/releases/download/9.6.0/7SCW.exe",
            "https://github.com/lackyhy/7SCW/releases/download/9.6.0/7SCW.zip",
            "https://github.com/lackyhy/7SCW/archive/refs/tags/9.6.0.zip",
            "https://github.com/lackyhy/7SCW/releases/latest/download/7SCW.exe"
        };
    }
...
void installUpdate() {
    ...
    system("start update_installer.bat");
