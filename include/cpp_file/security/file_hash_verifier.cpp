...
void FileHashVerifier::loadKnownHashes() {
    Logger::info("Loading known file hashes for verification");
    ...
    Logger::success("Loaded " + to_string(knownHashes.size()) + " known file hashes");
}

void FileHashVerifier::scanSystemFiles() {
    Logger::info("Starting system files scan");
    ...
    Logger::success("System files scan completed");
}
...
void FileHashVerifier::verifySystemFiles() {
    Logger::info("Starting system files integrity verification");
    system("cls");
    cout << "========================================" << endl;
